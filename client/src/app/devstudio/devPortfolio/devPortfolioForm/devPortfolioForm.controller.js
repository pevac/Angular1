    ...
    function DevPortfolioFormController( $timeout, $state,  ImageService, Resources) {
        ...
        vm.changeTop = function (project) {
            Resources.DevProjects.query(function (data) {
                ...
                if (!((_isCheckTop && !project.inTop || !project.inTop && !_isCheckTop || project.inTop && _isCheckTop || isTop && project.inTop && !_isCheckTop))) {
        ...
        function addImage(image, name){
            ...
            return Resources.DevProjectFile.saveFile( {data: image, id:  vm.project.id},
                function () {
