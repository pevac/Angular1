(function(){
    "use strict";
    angular.module("homeModule", ["bu.validation",  "serverApi",   "devPortfolioModule", "intPortfolioModule", "orderCustomerModule", "vacancyModule", 
    ...
    HomeController.$inject = ["$scope", "$rootScope", "AUTH_EVENTS", "USER_ROLES", "AuthService", "UserService"];

    function HomeController ($scope, $rootScope, AUTH_EVENTS, USER_ROLES, AuthService, UserService) {
