 ...
 angular.module("angularApp").run(["$templateCache", function($templateCache) {
  $templateCache.put("pagination/pagination.html",
      ...
      "<li  ng-class=\"{disabled: currentPage === stDisplayedPages||ngDisabled}\" class=\"pagination-next\"><a href=\"javascript: void(0);\" ng-click=\"selectPage(currentPage + 1, $event)\" ng-disabled=\"currentPage === stDisplayedPages || ngDisabled\" uib-tabindex-toggle>></a></li>\n" +
      "<li  ng-class=\"{disabled: currentPage === stDisplayedPages||ngDisabled}\" class=\"pagination-last\"><a href=\"javascript: void(0);\" ng-click=\"selectPage(stDisplayedPages, $event)\" ng-disabled=\"currentPage === stDisplayedPages ||ngDisabled\" uib-tabindex-toggle>>></a></li>\n" +
      "</ul></nav>" +
      "");
 }]);
